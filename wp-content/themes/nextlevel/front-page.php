	...
	<section id="main">
		...
		<!-- One -->
			<section id="one" class="wrapper style1">
				...
				<div class="image fit flush">
					<img src="<?php echo get_stylesheet_uri(); ?>/src/assets/images/pic02.jpg" alt="" />
				</div>
			...
			<section id="two" class="wrapper style2">
				...
				<div class="content">
					<div class="gallery">
						<div>
							<div class="image fit flush">
								<a href="images/pic03.jpg"><img src="<?php echo get_stylesheet_uri(); ?>/src/assets/images/pic03.jpg" alt="" /></a>
							</div>
						</div>
						<div>
							<div class="image fit flush">
								<a href="images/pic01.jpg"><img src="<?php echo get_stylesheet_uri(); ?>/src/assets/images/pic01.jpg" alt="" /></a>
							</div>
						</div>
						<div>
							<div class="image fit flush">
								<a href="images/pic04.jpg"><img src="<?php echo get_stylesheet_uri(); ?>/src/assets/images/pic04.jpg" alt="" /></a>
							</div>
						</div>
						<div>
							<div class="image fit flush">
								<a href="images/pic05.jpg"><img src="<?php echo get_stylesheet_uri(); ?>/src/assets/images/pic05.jpg" alt="" /></a>
							</div>
						</div>
					</div>
				</div>
		...
		<!-- Three -->
			<section id="three" class="wrapper">
				<div class="spotlight">
					<div class="image flush"><img src="<?php echo get_stylesheet_uri(); ?>/src/assets/images/pic06.jpg" alt="" /></div>
					<div class="inner">
				...
				<div class="spotlight alt">
					<div class="image flush"><img src="<?php echo get_stylesheet_uri(); ?>/src/assets/images/pic07.jpg" alt="" /></div>
					<div  class="inner">
				...
				<div class="spotlight">
					<div class="image flush"><img src="<?php echo get_stylesheet_uri(); ?>/src/assets/images/pic08.jpg" alt="" /></div>
					<div class="inner">
